...
import com.LibraryMS.BookIssueDeal.Model.*;
import com.LibraryMS.BookIssueDeal.Repository.TransactionRepository;
...
public class TransactionService {
    ...
    public String issueBook(int studentId, int bookId) throws Exception {
        ...
        /**
         *  Transaction - holds the Student ID and Book ID in the Transaction Table
         */
        ...
        try {
             ...
             * Update the book in Book table in DB - For above case "Book is already issued to someone else!"
             *
             */
